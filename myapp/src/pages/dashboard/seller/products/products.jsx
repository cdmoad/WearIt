      ...
      <div className="flex justify-start items-center z-[-1] mr-2">
        <form   className="max-w-[280px]  ">
            <div className="relative">
                <input type="text" onChange={(e)=>setSearch(e.target.value)} value={search}   className="w-full border h-10 shadow-sm px-4 pr-10 rounded-md outline-none" placeholder="search" />
                <button type="submit">
          ...
          <div className="flex items-center justify-between sm:justify-end">
            <div className="flex items-center">
              ...
              <select name="" className="sm: mr-4 block w-full whitespace-pre rounded-lg border p-1  py-2  pr-10 text-base outline-none focus:shadow sm:text-sm">
                <option className="whitespace-no-wrap text-sm">Category1</option>
                <option className="whitespace-no-wrap text-sm">Category2</option>
                <option className="whitespace-no-wrap text-sm">Category3</option>
              </select>
            </div>
        ...
        <table className="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
          ...
          <tbody className="lg:border-gray-300">
            {isSuccess ? (search ? prods : products)?.map((product)=>(
              ...
              <td width="100%" className="whitespace-no-wrap py-3 text-sm font-bold text-gray-900 sm:px-6 flex">
              ...
              <td className="whitespace-no-wrap px-6   py-3 text-sm font-normal text-gray-500 sm:px-6  ">
                {product.stock}
                </td>
