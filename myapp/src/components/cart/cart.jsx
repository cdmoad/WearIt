...
<motion.div
  class="fixed top-16 right-0 w-screen  max-w-sm border shadow-lg   bg-gray-100 px-4 py-8 sm:px-6 lg:px-8 "
  aria-modal="true"
  role="dialog"
  tabindex="-1"
  animate={{ x: 0 }}
  ...
  exit={{ x: 500 }}
>
  <button onClick={toggleCart} class="absolute end-4 top-4 text-gray-600 transition hover:scale-110">
