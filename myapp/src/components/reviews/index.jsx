...
function Index({review,star,userName}) {
  return (
    <div class="flex items-start px-4 py-6 md:px-10 md:pb-8 md:pt-4">
    ...
    <div class="ml-6">
      ...
      <div class="flex items-center mt-1">
        <svg class={`w-4 h-4 fill-current ${star>0 ? 'text-yellow-600' : 'text-gray-400' } `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
        <svg class={`w-4 h-4 fill-current  ${star>1 ? 'text-yellow-600' : 'text-gray-400' } `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
        <svg class={`w-4 h-4 fill-current  ${star>2 ? 'text-yellow-600' : 'text-gray-400' } `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
        <svg class={`w-4 h-4 fill-current  ${star>3 ? 'text-yellow-600' : 'text-gray-400' } `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
        <svg class={`w-4 h-4 fill-current  ${star>4 ? 'text-yellow-600' : 'text-gray-400' } `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
      </div>
